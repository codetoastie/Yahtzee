...
class Rule {
  ...
  freq(dice) {
    ...
    //* This will Calculate the No. of occurance of the dice numbers.
    //* arr = [1,1,1,1,1]  -> Freq -> [5] 
    //* It will give a new Array that contain the occurance but it will not tell which number occured how many times. 
    //* Like If we are looking for Yahtzee then Condition will be freq[0]=5
    //* For ex -> For a Full house (3 of a Kind and 2 of a kind)
    //*The freq table is  freq-> [2,3] or [3,2]
  }
 ...
 */
  ...
  //! All the Classes here have a Method called evalRoll.
...
class FullHouse extends Rule{
  evalRoll = dice => {
    return this.freq(dice).sort()[0]===2 && this.freq(dice).sort()[1]===3 ? this.score:0;

  }
}

/** Check for small straights. */
//* Condition -> 4 in a Row 
/*
1) [1,2,3,4,2] -> Set(4)
2) [1,2,3,4,6] -> Set(5)

So the Approach will be like that we make an set if it has the value >= 4 then it is a small staright.
*/
